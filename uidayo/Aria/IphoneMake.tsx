import { pen1, pen4, pen5, pen6, pencil } from "@/utils/Portal";
  ...
  return (
    <>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div className="flex flex-col items-center text-center bg-black p-4 rounded-lg shadow">
          <p className="text-gray-400 font-medium mb-4">
            Ceramic&nbsp;Shield&nbsp;2 3x&nbsp;more&nbsp;scratch resitant
          </p>
          <div className="w-full flex justify-center items-center overflow-hidden">
            <figure className="w-full flex justify-center max-h-40">
              <img src={pen6} alt="blue iphone" className="object-contain" />
            </figure>
          </div>
        </div>
        {/* part6 */}
